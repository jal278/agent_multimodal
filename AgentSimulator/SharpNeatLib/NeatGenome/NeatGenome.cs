...
namespace SharpNeatLib.NeatGenome
{
	...
	{	
		...
		public override IGenome CreateOffspring_Sexual(EvolutionAlgorithm ea, IGenome parent)
		{
            ...
            // Schrum: Modified to add outputsPerPolicy as a parameter
			return new NeatGenome(ea.NextGenomeId, newNeuronGeneList, newModuleGeneList, newConnectionGeneList, inputNeuronCount, outputNeuronCount, outputsPerPolicy);
		}
