...
namespace SharpNeatLib.Experiments
{
	public interface IExperiment
	{
        ...
        /// <summary>
        /// The number of output neurons required to define a single policy.
        /// By default, this is the same as OutputNeuronCount, but networks can
        /// also have multiple output modules.
        /// </summary>
        // Schrum: Added to allow multiple output modules
