...
namespace SharpNeatLib.NeuralNetwork
{
    public class ModularNetwork : INetwork
    {
        ...
        // Schrum: For deciding which output module to use
        int currentOutputModule = 0; // Schrum: Default that never changes in regular NEAT networks
        // Schrum: Number of neurons per module
        ...
        public void SetInputSignals(float[] signalArray)
        {
            ...
            //Console.Write("signalArray: ");
            //Array.ForEach(signalArray, x => Console.Write(x +","));
            //Console.WriteLine();
            //Console.Write("neuronSignals: ");
            //Array.ForEach(neuronSignals, x => Console.Write(x + ","));
            //Console.WriteLine();

            // Schrum: More debugging
            //Console.WriteLine("biasNeuronCount:" + biasNeuronCount);
            //Console.WriteLine("inputNeuronCount:" + inputNeuronCount);
            //Console.WriteLine("totalInputNeuronCount:"+totalInputNeuronCount);
            //Console.WriteLine("outputNeuronCount:"+outputNeuronCount);
            //Console.WriteLine("outputsPerPolicy:"+outputsPerPolicy);
            //Console.WriteLine("neuronSignals.Length:"+neuronSignals.Length);
        ...
        // Schrum: Shold be case that: 0 <= index < outputsPerPolicy
        public float GetOutputSignal(int index)
        {
            // For speed we don't bother with bounds checks.
            return neuronSignals[totalInputNeuronCount + 
                (currentOutputModule * outputsPerPolicy) + // Schrum: Added to pick a specific module
                index];
        }
        ...
        public int CurrentOutputModule
        {
            get
            {
                return currentOutputModule;
            }
            set
            {
                currentOutputModule = value;
            }
        }
