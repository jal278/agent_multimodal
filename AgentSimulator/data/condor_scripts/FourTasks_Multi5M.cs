...
arguments = ./AgentSimulator.exe evolve -experiment FourTasks-EXP-multi-5M.xml -generations 5000 -rng_seed $(Process) -folder results/FourTasks-EXP-multi-5M-$(Process)-
queue 30
