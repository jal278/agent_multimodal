...
arguments = ./AgentSimulator.exe evolve -experiment FourTasks-EXP-multi-MMD.xml -generations 4000 -rng_seed $(Process) -folder results/FourTasks-EXP-multi-MMD-$(Process)-
queue 30
