...
arguments = ./AgentSimulator.exe evolve -experiment FourTasks-EXP-multi-3M.xml -generations 3000 -rng_seed $(Process) -folder results/FourTasks-EXP-multi-3M-$(Process)-
queue 30
