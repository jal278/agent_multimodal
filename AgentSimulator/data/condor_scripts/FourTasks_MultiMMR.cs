...
arguments = ./AgentSimulator.exe evolve -experiment FourTasks-EXP-multi-MMR.xml -generations 3000 -rng_seed $(Process) -folder results/FourTasks-EXP-multi-MMR-$(Process)-
queue 30
